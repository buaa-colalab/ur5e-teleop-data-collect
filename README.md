...
本文档介绍了如何使用UR5e机械臂和DH夹爪进行数据采集，包含开机、关机、通过控制面板控制机械臂运动、通过远程python代码控制机械臂运动与夹爪状态、使用遥操臂或键盘进行数据采集以及数据格式转换等内容。设备配置为 UR5e 机械臂、DH AG 夹爪、2x 大疆 Osmo Action 5Pro、玄雅 UR 构型遥操机械臂。
